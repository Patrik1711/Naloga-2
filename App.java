	...
	public static void main(String[] args) throws SQLException, ClassNotFoundException {
		...
		do {
			...
			if(odgovor.matches("1")) {
				...
				SQLiteTest test2 = new SQLiteTest();
				test2.test();
				...
				if(odgovor1.matches("DA")) {
					SQLiteTest test3 = new SQLiteTest();
					test3.izbrisVsehStevilke();
				...
				SQLiteTest test4 = new SQLiteTest();
				test4.izbrisStevilke();
